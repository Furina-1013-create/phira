...
item-offline-sub = Bạn không thể tải lên điểm số trong chế độ này.
...
about-content =
  ...
  Phira là một trò chơi nhịp điệu dựa trên cộng đồng phi thương mại, lấy cảm hứng từ Phigros, được phát triển bằng Rust.
